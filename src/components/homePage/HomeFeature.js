...
import { HomeFeatureSection, FeaturedContent, FeaturedVideo, FeaturedProject } from '../../styles/homeStyles'
...
const HomeFeature = ({ onCursor }) => {
    ...
    return (
        <HomeFeatureSection ref={featuredRef}
            animate={animation}
            initial='hidden'
            variants={{
                visible: {
        ...
        >
            <Container fluid>
                <Link>
                    <FeaturedContent
                        ...
                        <h2 className="featured-title">
                            ...
                            <span className='arrow'>
                                <motion.svg animate={{ x: hovered ? 40 : 0 }}
                                    transition={{ duration: .6, ease: [.6, .05, -.01, .9] }}
                    ...
                    <FeaturedVideo>
                        <video src={featuredVideo} loop autoPlay muted></video>
                    </FeaturedVideo>
                </Link>
            </Container>
            <Container>
